    ...
    <nav className="border-b border-border bg-background">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 relative">
          ...
          <div className="hidden xl:block absolute left-1/2 -translate-x-1/2 whitespace-nowrap text-center text-2xl font-bold text-muted-foreground">
          ...
          <div className="flex items-center gap-1">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" size="lg" aria-label="Support Wallii">
                  <Heart data-icon="inline-start" />
                  <span className="hidden [@media(min-width:431px)]:block">Support</span>
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent align="center" className="w-44">
                <DropdownMenuLabel>Support Wallii</DropdownMenuLabel>
                <DropdownMenuSeparator />
                <DropdownMenuGroup>
                  <DropdownMenuItem asChild>
                    <a href="https://patreon.com/wallii" target="_blank" rel="noopener noreferrer">
                      <Heart />
                      Patreon
                    </a>
                  </DropdownMenuItem>
                  ...
                  <DropdownMenuItem asChild>
                    <a href="https://www.twitch.tv/liihs" target="_blank" rel="noopener noreferrer">
                      <span className="flex size-4 items-center justify-center">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <DropdownMenuItem asChild>
                    <a href="https://discord.com/invite/XGZg7PEn9B" target="_blank" rel="noopener noreferrer">
                      <span className="flex size-4 items-center justify-center">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <DropdownMenuItem asChild>
                    <a href="https://x.com/lii_hs" target="_blank" rel="noopener noreferrer">
                      <span className="flex size-4 items-center justify-center">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                          <path d="M4.25 3h5.516l3.7 5.03L17.5 3h2.73l-6.08 7.34L21 21h-5.516l-4.038-5.487L7.5 21H4.75l6.4-7.742L4.25 3z" />
                        </svg>
                      </span>
                      X
                    </a>
